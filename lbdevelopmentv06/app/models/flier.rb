class Flier < ActiveRecord::Base
  attr_accessible :category, :community_id, :description, :image,
    ...
    validates :description, :presence => {  class: "validates", :message => "You need to describe your event"}
    validates :image, :presence => { :message => "You must upload an image for your event." }
    validates :start_time, :presence => true
    validates :title, :presence => { class: "validates", :message => "Your event needs a title." }
